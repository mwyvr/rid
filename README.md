...
|-----------------------------------------------------------|----|----|-------|-------|---------------------|--------|------------|
| [solutionroute/rid](https://github.com/solutionroute/rid)<br>Base32 (default) | 15 | 24 |  true |  true | `062etgb81cvzw18pw05tfh6q`<br>`062etgb81cvna990skn0b84d` | fastrand | 6 byte ts(ms) : 1 byte machine/pid signature : 6 byte random |
| [solutionroute/rid](https://github.com/solutionroute/rid)<br>Base64 (optional) | 15 | 20 |  true |  true | `AYTtQWgLNy9sGpYlFcFc`<br>`AYTtQWgLN/Kk9vp1vUq5` | fastrand | 6 byte ts(ms) : 1 byte machine/pid signature : 6 byte random |
| [rs/xid](https://github.com/rs/xid)                       | 12 | 20 |  true |  true | `ce8b958p26gd5s4dfomg`<br>`ce8b958p26gd5s4dfon0` | counter | 4 byte ts(sec) : 2 byte mach ID : 2 byte pid : 3 byte monotonic counter |
| [segmentio/ksuid](https://github.com/segmentio/ksuid)     | 20 | 27 |  true |  true | `2IaluYnr7u4wct48IHoZYUUpiqs`<br>`2IaluYS3TqnVIeERrIqwl0pgZrE` | random | 4 byte ts(sec) : 16 byte random |
| [google/uuid](https://github.com/google/uuid)             | 16 | 36 | false |  true | `8a209444-77b7-411c-9d1c-d95276133d6b`<br>`0b94886b-b4f2-4277-9fab-4700ce244c73` | crypt/rand | v4: 16 bytes random with version & variant embedded |
| [oklog/ulid](https://github.com/oklog/ulid)               | 16 | 26 |  true |  true | `01GKPM2T0BKPQ53KVDZSTEQPDM`<br>`01GKPM2T0B7RMJEHSK5BQTRJ9E` | crypt/rand | 6 byte ts(ms) : 10 byte counter random init per ts(ms) |
| [kjk/betterguid](https://github.com/kjk/betterguid)       | 17 | 20 |  true |  true | `-NIhFLVAGoFPkEyfFN2q`<br>`-NIhFLVAGoFPkEyfFN2r` | counter | 8 byte ts(ms) : 9 byte counter random init per ts(ms) |
